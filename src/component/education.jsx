...
const Education = () => {
  return (
    <div className="bg-gray-900 p-8 rounded-lg mt-8">
      <h2 className="text-3xl text-white mb-6">education</h2>
      <div className="space-y-6">
        {education.map((education, index) => (
          <div key={index} className="bg-gray-800 p-4 rounded-lg">
            <div className="flex items-center mb-2">
              <span className="text-gray-400 mr-4">{education.period}</span>
              <h3 className="text-xl text-white">{education.company}</h3>
            </div>
            <h4 className="text-lg text-gray-300">{education.role}</h4>
